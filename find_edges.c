...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2020/06/01 14:03:36 by jmetelin          #+#    #+#             */
/*   Updated: 2020/06/01 15:03:37 by atuomine         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void			find_edges(t_room **head, t_room **start, t_room **end)
{
	...
	*end = NULL;
	while (room)
	{
		if (room->type == START && !*start)
			...
			*end = room;
			...
			handle_error(0, "Multiple ##start or ##end rooms");
	...
	if (!*start || !*end)
		handle_error(0, "No ##start or/and ##end");
}
